...
class ViewAdminProfile extends StatefulWidget {
  const ViewAdminProfile({Key? key}) : super(key: key);
...
class _ViewAdminProfileState extends State<ViewAdminProfile> {
  String username="",  name="",email="",projectNumber="",taskNumber="",contactNumber="";
  String companyContact="",companyDesc="",companyEmail="";
  bool isLoaded=false;
  var projectList=[];
  var taskList=[];
  ...
  getTaskList() {
    ...
    projectList=context.watch<Data>().listOfProjectsNotifier;
  }
  ...
  getUserDetails() async{
    ...
    name=finalData[" name"]??"";
    companyContactController.text=finalData["companyNumber"].toString();
    nameController.text=finalData["name"]??"";
    companyEmailController.text=finalData["companyEmail"]??"";
    companyDescriptionController.text=finalData["companyDescription"]??"";
    contactController.text=finalData["phoneNumber"].toString();
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: Constants.kTextFormFieldDecoration("NAME"),
                  //  maxLines: 2,
                  ),
                  TextFormField(
                  ...
                  TextFormField(
                    ...
                    decoration: Constants.kTextFormFieldDecoration("COMPANY DESCRIPTION"),
                  //  maxLines: 2,
                  ),
                  TextFormField(
                    controller:companyEmailController,
                    decoration: Constants.kTextFormFieldDecoration("COMPANY EMAIL"),
                   // maxLines: 2,
                  ),
                  TextFormField(
                    controller:companyContactController,
                    decoration: Constants.kTextFormFieldDecoration("COMPANY CONTACT"),
                   // maxLines: 2,
                  ),
                  // TextFormField(
                  //   decoration: Constants.kTextFormFieldDecoration("Contact"),
