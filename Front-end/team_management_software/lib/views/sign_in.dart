...
class SignInPage extends StatefulWidget {
  final String role;
  const SignInPage({Key? key, required this.role}) : super(key: key);
  @override
...
class _SignInPageState extends State<SignInPage> {
  ...
  validateAndSignIn() async {
    ...
    if (form!) {
      ...
      String signInResponse = await httpFunctions.signInUser(
                ...
                child: Column(
                  children: <Widget>[
                    TextFormField(
                      ...
                      validator: (val) {
                        val ??= " ";
                        return val.length >= 1 ? null : " Enter a valid username";
                      },
                      decoration:
                          Constants.kTextFormFieldDecoration("USERNAME"),
                    ),
                    SizedBox(height: 1.h),
                    TextFormField(
                      ...
                      decoration:
                          Constants.kTextFormFieldDecoration("PASSWORD"),
                      obscureText: true,
                    ),
                    SizedBox(height: 5.h),
                    GestureDetector(
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          child: Center(
                            child: Text(widget.role == "admin"?'Don\'t have an account? SignUp as Admin':'Don\'t have an account? SignUp as User',
                                style: TextStyle(
                                    fontSize: 9.sp,
                                    fontWeight: FontWeight.bold,
                                    fontFamily: 'Montserrat')),
